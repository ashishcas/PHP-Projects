...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(70,10,'SHOW TICKET',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$result = mysqli_query($connString, "SELECT ticketid, name, showdate, seatno FROM booking 
        where ticketid = '$ticket_id'") or die("database error:". mysqli_error($connString));
