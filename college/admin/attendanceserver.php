...
$_SESSION['last_action'] = time();
      ...
      if(isset($_POST['attend_admin']))
      {
          ...
          $percentage =$_POST['percentage'];          
           ...
           $sql = "INSERT  INTO attendance (username,subject,june,july,august,september,october,november,december,january,february,march,percentage)
      VALUES('$uname','$sub','$june','$july','$august','$september','$october','$november',
